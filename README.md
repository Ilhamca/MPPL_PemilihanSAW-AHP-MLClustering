...
Requirement:
Implementasi Metode Hybrid: Menerapkan metode gabungan Analytical Hierarchy 
Process (AHP) untuk proses pembobotan kriteria secara sistematis dan objektif, serta metode Simple Additive Weighting (SAW) untuk melakukan proses perankingan alternatif laptop secara efisien dan akurat. 
b. Integrasi Machine Learning: Mengintegrasikan algoritma machine learning, yaitu clustering dengan metode K-Means, untuk menganalisis dan mengelompokkan dataset laptop secara otomatis ke dalam kategori-kategori yang relevan dengan tipe pengguna mahasiswa (misalnya: kebutuhan desain grafis, programming, atau penggunaan 
umum).  
